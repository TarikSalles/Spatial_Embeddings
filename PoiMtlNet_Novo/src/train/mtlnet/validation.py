...
def validation_best_model(data_next,
    ...
    print("\n=========== CONFUSION MATRIX — NEXT POI (best model) ===========")
    print(confusion_matrix(truth_next, pred_next))

    print("\n=========== CONFUSION MATRIX — CATEGORY (best model) ===========")
    print(confusion_matrix(truth_category, pred_category))
