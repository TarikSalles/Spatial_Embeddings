...
from src.common.calc_flops.calculate_model_flops import calculate_model_flops
from src.common.mps_support import clear_mps_cache
from src.common.training_progress import TrainingProgressBar
from src.configs.globals import DEVICE
from src.configs.model import ModelParameters, MTLModelConfig, InputsConfig
from src.criterion.nash_mtl import NashMTL
from src.etl.mtl.create_fold import SuperInputData
from src.model.mtlnet.mtl_poi import MTLnet
from src.configs.next_config import CfgNextModel
from src.common.ml_history.metrics import MLHistory, FoldHistory, FlopsMetrics
from src.common.ml_history.parms.neural import NeuralParams
from src.train.mtlnet.evaluate import evaluate_model
from src.train.mtlnet.validation import validation_best_model

class FocalLoss(nn.Module):
    def __init__(self, alpha=None, gamma=2.0, reduction='mean'):
        super().__init__()
        self.alpha = alpha  # tensor de pesos por classe ou None
        self.gamma = gamma
